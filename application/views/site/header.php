...
<div class="top-bar">
    <div class="container">
        ...
        <ul class="kt-nav top-bar-menu right">
            <li>
                <a href="<?php echo site_url('user/register')?>"><span class="menu-icon pe-7s-add-user"></span> Đăng Ký</a>
		 </li>
			<li>
			<a href="<?php echo site_url('user/login') ?>"><span class="menu-icon pe-7s-add-user"></span> Đăng nhập</a>
			</li>
