<?php
    class Product extends MY_Controller{
        ...
        function catalog(){
            ...
            $input = array();
			//$input là mảng điều kiện để  lấy ra các bản ghi trong csdl.Do hiển thị tất cả các danh mục nên chúng ta không cần truyền giá trị cho $input.Giá trị get_list sẽ là một mảng $data[‘list’] bao gồm tất cả các bản ghi trong bảng catalog
        ...
        function search(){
            if($this->uri->rsegment('3') == 1){
                ...
                $key =$this->security->xss_clean($this->input->get('key-search'));
            }
