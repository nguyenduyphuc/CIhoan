<?php
    class User extends MY_Controller
    {
        ...
        function register(){
            ...
            if($this->input->post()){
                $this->form_validation->set_rules('name', 'Nhập Họ tên ', 'required|xss_clean' );
                $this->form_validation->set_rules('email', 'Nhập Email ', 'required|valid_email|callback_check_email' );
                $this->form_validation->set_rules('password', 'Nhập password ', 'required|min_length[4]|xss_clean' );
                $this->form_validation->set_rules('rpassword', 'Nhập Nhập lại Password ', 'required|matches[password]|xss_clean' );
